...
const Login = () => {
  ...
  return (
    <div className="flex align-center full-height">
      <div className="flex align-center justify-center half-width yellowbg full-height loginBg">
        <img src={bee} alt="" className="bg-img" />
      </div>
      <div className="flex column justify-center align-center half-width  full-height g30 yellowbglight">
        <div className="loginCard flex column justify-center align-center">
